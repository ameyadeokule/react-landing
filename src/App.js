...
function App() {
  ...
  return (
    <div className='min-h-screen w-screen flex justify-center item-center flex-col-reverse lg:flex-row lg:justify-around' style={{background:'linear-gradient(to bottom, #F0F4FD,#A1A3BA)'}}>
      ...
      <div className={`${isAnimated?'scale-y-100':'scale-y-0'} mt-10 text-center lg:text-left transform transition duration-1000 ease-in-out`}>
        <h1 className='font-black text-5xl lg:text-6xl'>Fresh Healthy<br /> <span className='font-quicksand font-light'>Delicious Salads</span></h1>
        <p className='text-base text-grey-700'>We make fresh and healthy food </p>
